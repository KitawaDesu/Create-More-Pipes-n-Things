...
public class SmartRoseGoldenFunnel extends FunnelBlock {

    public SmartRoseGoldenFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.SMART_ROSE_GOLDEN_BELT_FUNNEL.getDefaultState()
