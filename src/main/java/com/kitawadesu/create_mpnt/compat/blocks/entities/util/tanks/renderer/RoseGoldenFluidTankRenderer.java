...
public class RoseGoldenFluidTankRenderer extends FluidTankRenderer {

    public RoseGoldenFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderAsBoiler(FluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            CachedBuffers.partial(MPNTPartialModels.ROSE_GOLDEN_BOILER_GAUGE, blockState)
                    .rotateYDegrees(yRot)
                    .uncenter()
