...
public class SmartRosariteFunnel extends FunnelBlock {

    public SmartRosariteFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.SMART_ROSARITE_BELT_FUNNEL.getDefaultState()
