...
public class PyralFluidTankRenderer extends FluidTankRenderer {

    public PyralFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderAsBoiler(FluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            CachedBuffers.partial(MPNTPartialModels.PYRAL_BOILER_GAUGE, blockState)
                    .rotateYDegrees(yRot)
                    .uncenter()
