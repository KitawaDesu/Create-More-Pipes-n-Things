...
public class SmartValkyrumFunnel extends FunnelBlock {

    public SmartValkyrumFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.SMART_VALKYRUM_BELT_FUNNEL.getDefaultState()
