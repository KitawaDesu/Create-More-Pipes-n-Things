...
public class RosariteFluidTankRenderer extends FluidTankRenderer {

    public RosariteFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderAsBoiler(FluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            CachedBuffers.partial(MPNTPartialModels.ROSARITE_BOILER_GAUGE, blockState)
                    .rotateYDegrees(yRot)
                    .uncenter()
