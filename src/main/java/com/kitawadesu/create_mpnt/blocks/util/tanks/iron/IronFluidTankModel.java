...
public class IronFluidTankModel extends CTModel {

    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();

    public static IronFluidTankModel standard(BakedModel originalModel) {
        return new IronFluidTankModel(originalModel, MPNTSpriteShifts.IRON_FLUID_TANK, MPNTSpriteShifts.IRON_FLUID_TANK_TOP,
                MPNTSpriteShifts.IRON_FLUID_TANK_INNER);
    }

    public IronFluidTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
