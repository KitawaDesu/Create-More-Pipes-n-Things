...
public class NormalGoldenFunnel extends FunnelBlock {

    public NormalGoldenFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.NORMAL_GOLDEN_BELT_FUNNEL.getDefaultState()
