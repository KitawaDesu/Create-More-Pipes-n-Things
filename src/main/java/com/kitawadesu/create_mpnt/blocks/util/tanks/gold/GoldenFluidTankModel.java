...
public class GoldenFluidTankModel extends CTModel {

    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();

    public static GoldenFluidTankModel standard(BakedModel originalModel) {
        return new GoldenFluidTankModel(originalModel, MPNTSpriteShifts.GOLDEN_FLUID_TANK, MPNTSpriteShifts.GOLDEN_FLUID_TANK_TOP,
                MPNTSpriteShifts.GOLDEN_FLUID_TANK_INNER);
    }

    public GoldenFluidTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
