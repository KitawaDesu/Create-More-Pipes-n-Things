...
public class NetheriteTunnelCTBehaviour extends ConnectedTextureBehaviour.Base {
    ...
    public CTSpriteShiftEntry getShift(BlockState state, Direction direction, @Nullable TextureAtlasSprite sprite) {
        return direction == Direction.UP ? MPNTSpriteShifts.NETHERITE_TUNNEL_TOP : null;
    }
