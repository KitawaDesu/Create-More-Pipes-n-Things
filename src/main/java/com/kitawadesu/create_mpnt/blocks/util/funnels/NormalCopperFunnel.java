...
public class NormalCopperFunnel extends FunnelBlock {

    public NormalCopperFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.NORMAL_COPPER_BELT_FUNNEL.getDefaultState()
