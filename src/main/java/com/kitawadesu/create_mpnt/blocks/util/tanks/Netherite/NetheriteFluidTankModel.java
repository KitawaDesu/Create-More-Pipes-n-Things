...
public class NetheriteFluidTankModel extends CTModel {
    ...
    public static NetheriteFluidTankModel standard(BakedModel originalModel) {
        return new NetheriteFluidTankModel(originalModel, MPNTSpriteShifts.NETHERITE_FLUID_TANK, MPNTSpriteShifts.NETHERITE_FLUID_TANK_TOP,
                MPNTSpriteShifts.NETHERITE_FLUID_TANK_INNER);
    }

    public NetheriteFluidTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
