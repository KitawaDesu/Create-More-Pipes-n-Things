...
public class AndesiteFluidTankModel extends CTModel {
    ...
    public static AndesiteFluidTankModel standard(BakedModel originalModel) {
        return new AndesiteFluidTankModel(originalModel, MPNTSpriteShifts.ANDESITE_FLUID_TANK, MPNTSpriteShifts.ANDESITE_FLUID_TANK_TOP,
                MPNTSpriteShifts.ANDESITE_FLUID_TANK_INNER);
    }

    public AndesiteFluidTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
