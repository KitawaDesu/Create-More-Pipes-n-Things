...
public class NormalBrassFunnel extends FunnelBlock {

    public NormalBrassFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.NORMAL_BRASS_BELT_FUNNEL.getDefaultState()
