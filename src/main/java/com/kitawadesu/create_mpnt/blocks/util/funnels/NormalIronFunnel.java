...
public class NormalIronFunnel extends FunnelBlock {

    public NormalIronFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.NORMAL_IRON_BELT_FUNNEL.getDefaultState()
