...
public class NormalNetheriteFunnel extends FunnelBlock {

    public NormalNetheriteFunnel(Properties p_i48415_1_) {
        super(p_i48415_1_);
    }
    ...
    public BlockState getEquivalentBeltFunnel(BlockGetter world, BlockPos pos, BlockState state) {
        ...
        return CreateMPNTBlocks.NORMAL_NETHERITE_BELT_FUNNEL.getDefaultState()
