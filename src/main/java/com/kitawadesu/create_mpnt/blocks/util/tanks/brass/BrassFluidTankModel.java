...
public class BrassFluidTankModel extends CTModel {
    ...
    public static BrassFluidTankModel standard(BakedModel originalModel) {
        return new BrassFluidTankModel(originalModel, MPNTSpriteShifts.BRASS_FLUID_TANK, MPNTSpriteShifts.BRASS_FLUID_TANK_TOP,
                MPNTSpriteShifts.BRASS_FLUID_TANK_INNER);
    }

    public BrassFluidTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
