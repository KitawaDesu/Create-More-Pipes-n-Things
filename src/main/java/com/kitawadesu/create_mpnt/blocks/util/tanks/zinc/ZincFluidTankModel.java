...
public class ZincFluidTankModel extends CTModel {

    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();

    public static ZincFluidTankModel standard(BakedModel originalModel) {
        return new ZincFluidTankModel(originalModel, MPNTSpriteShifts.ZINC_FLUID_TANK, MPNTSpriteShifts.ZINC_FLUID_TANK_TOP,
                MPNTSpriteShifts.ZINC_FLUID_TANK_INNER);
    }

    public ZincFluidTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
