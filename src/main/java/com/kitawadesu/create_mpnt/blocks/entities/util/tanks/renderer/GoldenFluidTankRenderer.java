package com.kitawadesu.create_mpnt.blocks.entities.util.tanks.renderer;
...
public class GoldenFluidTankRenderer extends FluidTankRenderer {

    public GoldenFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderAsBoiler(FluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            CachedBuffers.partial(MPNTPartialModels.GOLDEN_BOILER_GAUGE, blockState)
                    .rotateYDegrees(yRot)
                    .uncenter()
