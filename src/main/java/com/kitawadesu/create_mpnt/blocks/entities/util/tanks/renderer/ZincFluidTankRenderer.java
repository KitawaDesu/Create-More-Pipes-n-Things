...
public class ZincFluidTankRenderer extends FluidTankRenderer {

    public ZincFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderAsBoiler(FluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            CachedBuffers.partial(MPNTPartialModels.ZINC_BOILER_GAUGE, blockState)
                    .rotateYDegrees(yRot)
                    .uncenter()
