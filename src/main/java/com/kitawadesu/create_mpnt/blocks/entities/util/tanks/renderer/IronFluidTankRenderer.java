...
public class IronFluidTankRenderer extends FluidTankRenderer {

    public IronFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderAsBoiler(FluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            CachedBuffers.partial(MPNTPartialModels.IRON_BOILER_GAUGE, blockState)
                    .rotateYDegrees(yRot)
                    .uncenter()
